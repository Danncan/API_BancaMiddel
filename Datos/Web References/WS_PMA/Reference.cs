...
namespace Datos.WS_PMA {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPMASoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPMA : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPMAOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPMA() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PMA_API_MostrarServicioPMA;
        ...
        /// <remarks/>
        public event mostrarPagosPMACompletedEventHandler mostrarPagosPMACompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPMA", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPMA[] mostrarPagosPMA(string cedula) {
            object[] results = this.Invoke("mostrarPagosPMA", new object[] {
                        cedula});
            return ((MostrarPagosPMA[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPMAAsync(string cedula) {
            this.mostrarPagosPMAAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPMAAsync(string cedula, object userState) {
            if ((this.mostrarPagosPMAOperationCompleted == null)) {
                this.mostrarPagosPMAOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPMAOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPMA", new object[] {
                        cedula}, this.mostrarPagosPMAOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPMAOperationCompleted(object arg) {
            if ((this.mostrarPagosPMACompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPMACompleted(this, new mostrarPagosPMACompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPMA {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPMACompletedEventHandler(object sender, mostrarPagosPMACompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPMACompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPMACompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPMA[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPMA[])(this.results[0]));
            }
        }
    }
