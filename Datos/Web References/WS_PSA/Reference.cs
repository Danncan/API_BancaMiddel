...
namespace Datos.WS_PSA {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServiciosPSASoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServiciosPSA : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback MostrarPagosPSAOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServiciosPSA() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PSA_API_MostrarServiciosPSA;
        ...
        /// <remarks/>
        public event MostrarPagosPSACompletedEventHandler MostrarPagosPSACompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/MostrarPagosPSA", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPSA[] MostrarPagosPSA(string cedula) {
            object[] results = this.Invoke("MostrarPagosPSA", new object[] {
                        cedula});
            return ((MostrarPagosPSA[])(results[0]));
        }
        
        /// <remarks/>
        public void MostrarPagosPSAAsync(string cedula) {
            this.MostrarPagosPSAAsync(cedula, null);
        }
        
        /// <remarks/>
        public void MostrarPagosPSAAsync(string cedula, object userState) {
            if ((this.MostrarPagosPSAOperationCompleted == null)) {
                this.MostrarPagosPSAOperationCompleted = new System.Threading.SendOrPostCallback(this.OnMostrarPagosPSAOperationCompleted);
            }
            this.InvokeAsync("MostrarPagosPSA", new object[] {
                        cedula}, this.MostrarPagosPSAOperationCompleted, userState);
        }
        
        private void OnMostrarPagosPSAOperationCompleted(object arg) {
            if ((this.MostrarPagosPSACompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.MostrarPagosPSACompleted(this, new MostrarPagosPSACompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPSA {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void MostrarPagosPSACompletedEventHandler(object sender, MostrarPagosPSACompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class MostrarPagosPSACompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal MostrarPagosPSACompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPSA[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPSA[])(this.results[0]));
            }
        }
    }
