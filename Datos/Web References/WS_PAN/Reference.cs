...
namespace Datos.WS_PAN {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPANSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPAN : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPANsOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPAN() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PAN_API_MostrarServicioPAN;
        ...
        /// <remarks/>
        public event mostrarPagosPANsCompletedEventHandler mostrarPagosPANsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPANs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPAN[] mostrarPagosPANs(string cedula) {
            object[] results = this.Invoke("mostrarPagosPANs", new object[] {
                        cedula});
            return ((MostrarPagosPAN[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPANsAsync(string cedula) {
            this.mostrarPagosPANsAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPANsAsync(string cedula, object userState) {
            if ((this.mostrarPagosPANsOperationCompleted == null)) {
                this.mostrarPagosPANsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPANsOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPANs", new object[] {
                        cedula}, this.mostrarPagosPANsOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPANsOperationCompleted(object arg) {
            if ((this.mostrarPagosPANsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPANsCompleted(this, new mostrarPagosPANsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPAN {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPANsCompletedEventHandler(object sender, mostrarPagosPANsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPANsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPANsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPAN[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPAN[])(this.results[0]));
            }
        }
    }
