...
namespace Datos.WS_PAH {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPAHSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPAH : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPCAsOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPAH() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PAH_API_MostrarServicioPAH;
        ...
        /// <remarks/>
        public event mostrarPagosPCAsCompletedEventHandler mostrarPagosPCAsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPCAs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPAH[] mostrarPagosPCAs(string cedula) {
            object[] results = this.Invoke("mostrarPagosPCAs", new object[] {
                        cedula});
            return ((MostrarPagosPAH[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPCAsAsync(string cedula) {
            this.mostrarPagosPCAsAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPCAsAsync(string cedula, object userState) {
            if ((this.mostrarPagosPCAsOperationCompleted == null)) {
                this.mostrarPagosPCAsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPCAsOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPCAs", new object[] {
                        cedula}, this.mostrarPagosPCAsOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPCAsOperationCompleted(object arg) {
            if ((this.mostrarPagosPCAsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPCAsCompleted(this, new mostrarPagosPCAsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPAH {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPCAsCompletedEventHandler(object sender, mostrarPagosPCAsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPCAsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPCAsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPAH[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPAH[])(this.results[0]));
            }
        }
    }
