...
namespace Datos.WS_PDS {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPDSSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPDS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPDSsOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPDS() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PDS_API_MostrarServicioPDS;
        ...
        /// <remarks/>
        public event mostrarPagosPDSsCompletedEventHandler mostrarPagosPDSsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPDSs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPDS[] mostrarPagosPDSs(long cedula) {
            object[] results = this.Invoke("mostrarPagosPDSs", new object[] {
                        cedula});
            return ((MostrarPagosPDS[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPDSsAsync(long cedula) {
            this.mostrarPagosPDSsAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPDSsAsync(long cedula, object userState) {
            if ((this.mostrarPagosPDSsOperationCompleted == null)) {
                this.mostrarPagosPDSsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPDSsOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPDSs", new object[] {
                        cedula}, this.mostrarPagosPDSsOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPDSsOperationCompleted(object arg) {
            if ((this.mostrarPagosPDSsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPDSsCompleted(this, new mostrarPagosPDSsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPDS {
        
        private System.Nullable<long> cedulaField;
        
        private string codpagoField;
        ...
        public System.Nullable<long> cedula {
            get {
        ...
        public string codpago {
            get {
                return this.codpagoField;
            }
            set {
                this.codpagoField = value;
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPDSsCompletedEventHandler(object sender, mostrarPagosPDSsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPDSsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPDSsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPDS[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPDS[])(this.results[0]));
            }
        }
    }
