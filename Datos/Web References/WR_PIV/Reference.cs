...
namespace Datos.WR_PIV {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPIVSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPIV : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPIVsOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPIV() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WR_PIV_API_MostrarServicioPIV;
        ...
        /// <remarks/>
        public event mostrarPagosPIVsCompletedEventHandler mostrarPagosPIVsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPIVs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPIV[] mostrarPagosPIVs(string cedula) {
            object[] results = this.Invoke("mostrarPagosPIVs", new object[] {
                        cedula});
            return ((MostrarPagosPIV[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPIVsAsync(string cedula) {
            this.mostrarPagosPIVsAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPIVsAsync(string cedula, object userState) {
            if ((this.mostrarPagosPIVsOperationCompleted == null)) {
                this.mostrarPagosPIVsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPIVsOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPIVs", new object[] {
                        cedula}, this.mostrarPagosPIVsOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPIVsOperationCompleted(object arg) {
            if ((this.mostrarPagosPIVsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPIVsCompleted(this, new mostrarPagosPIVsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPIV {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPIVsCompletedEventHandler(object sender, mostrarPagosPIVsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPIVsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPIVsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPIV[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPIV[])(this.results[0]));
            }
        }
    }
