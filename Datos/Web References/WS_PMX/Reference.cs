...
namespace Datos.WS_PMX {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPMXSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPMX : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback mostrarPagosPMXsOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPMX() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PMX_API_MostrarServicioPMX;
        ...
        /// <remarks/>
        public event mostrarPagosPMXsCompletedEventHandler mostrarPagosPMXsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/mostrarPagosPMXs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public MostrarPagosPMX[] mostrarPagosPMXs(string cedula) {
            object[] results = this.Invoke("mostrarPagosPMXs", new object[] {
                        cedula});
            return ((MostrarPagosPMX[])(results[0]));
        }
        
        /// <remarks/>
        public void mostrarPagosPMXsAsync(string cedula) {
            this.mostrarPagosPMXsAsync(cedula, null);
        }
        
        /// <remarks/>
        public void mostrarPagosPMXsAsync(string cedula, object userState) {
            if ((this.mostrarPagosPMXsOperationCompleted == null)) {
                this.mostrarPagosPMXsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmostrarPagosPMXsOperationCompleted);
            }
            this.InvokeAsync("mostrarPagosPMXs", new object[] {
                        cedula}, this.mostrarPagosPMXsOperationCompleted, userState);
        }
        
        private void OnmostrarPagosPMXsOperationCompleted(object arg) {
            if ((this.mostrarPagosPMXsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.mostrarPagosPMXsCompleted(this, new mostrarPagosPMXsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class MostrarPagosPMX {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void mostrarPagosPMXsCompletedEventHandler(object sender, mostrarPagosPMXsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class mostrarPagosPMXsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal mostrarPagosPMXsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public MostrarPagosPMX[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((MostrarPagosPMX[])(this.results[0]));
            }
        }
    }
