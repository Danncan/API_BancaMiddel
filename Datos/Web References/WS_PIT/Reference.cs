...
namespace Datos.WS_PIT {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_MostrarServicioPITSoap", Namespace="http://tempuri.org/")]
    public partial class API_MostrarServicioPIT : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback mostrarServicioOperationCompleted;
        
        private System.Threading.SendOrPostCallback MostrarPagosPITOperationCompleted;
        ...
        /// <remarks/>
        public API_MostrarServicioPIT() {
            this.Url = global::Datos.Properties.Settings.Default.Datos_WS_PIT_API_MostrarServicioPIT;
        ...
        /// <remarks/>
        public event MostrarPagosPITCompletedEventHandler MostrarPagosPITCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/MostrarPagosPIT", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public DTOpago[] MostrarPagosPIT(string cedula) {
            object[] results = this.Invoke("MostrarPagosPIT", new object[] {
                        cedula});
            return ((DTOpago[])(results[0]));
        }
        
        /// <remarks/>
        public void MostrarPagosPITAsync(string cedula) {
            this.MostrarPagosPITAsync(cedula, null);
        }
        
        /// <remarks/>
        public void MostrarPagosPITAsync(string cedula, object userState) {
            if ((this.MostrarPagosPITOperationCompleted == null)) {
                this.MostrarPagosPITOperationCompleted = new System.Threading.SendOrPostCallback(this.OnMostrarPagosPITOperationCompleted);
            }
            this.InvokeAsync("MostrarPagosPIT", new object[] {
                        cedula}, this.MostrarPagosPITOperationCompleted, userState);
        }
        
        private void OnMostrarPagosPITOperationCompleted(object arg) {
            if ((this.MostrarPagosPITCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.MostrarPagosPITCompleted(this, new MostrarPagosPITCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void MostrarPagosPITCompletedEventHandler(object sender, MostrarPagosPITCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class MostrarPagosPITCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal MostrarPagosPITCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
